    ...
    for i in xrange(MAX_EPISODES):
        ...
        for j in xrange(MAX_EP_STEPS):
            ...
            if terminal:
                ...
                writer.flush()
                rewards_list.append((ep_reward * 1.0)/j)
                print 'Reward, episode, avg_q ', ((ep_reward *1.0)/ j) ,i, (ep_ave_max_q / float(j))
                break
    rewards_list = np.asarray(rewards_list)
    np.savez('rewards_list_ddpg_200.npz', rewards_list)
